...
> Hallo, M., Gallovic, F. (2016). Fast and cheap approximation of Green functions uncertainty for waveform-based earthquake source inversions. Geophysical Journal International, 207 (2), 1012-1029. [https://doi.org/10.1093/gji/ggw320](https://doi.org/10.1093/gji/ggw320)

### For the specific software version:
> Hallo, M., Gallovic, F. (2026). Uncertainty quantification in Bayesian earthquake source inversions, HPC ready routines (v1.3.3) [Software]. Zenodo. [https://doi.org/10.5281/zenodo.19343279](https://doi.org/10.5281/zenodo.19343279)
