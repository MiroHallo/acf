!---------------------------------------------------------------------
! Fortran 90 subroutines for determining covariance matrix by
...
!---------------------------------------------------------------------
!
! Authors: Miroslav HALLO, František GALLOVIC
! Charles University in Prague, Faculty of Mathematics and Physics
! E-mail: hallo@karel.troja.mff.cuni.cz
! Revision 2018/01: Corrected and tested for real signals
! Revision 2026/04: Modernized version
! Method:
...
MODULE ApproxCovMod
!---------------------------------------------------------------------
!  Module with subroutines axcf and saxcf
!---------------------------------------------------------------------
    implicit none
    save
    public
